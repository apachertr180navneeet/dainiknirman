var ContestAuthors = (function() {
    ...
    return {
         ...
         */
        init: function() {
            ContestAuthors.getRecords();
            ContestAuthors.changeStatus();
            ContestAuthors.destroyRecords();
            ContestAuthors.deleteRecord();
            ContestAuthors.dataTableCustomFilter();
        ...
        getRecords: function() {
            ...
            data_table = table = $dataTable.DataTable({
                ...
                columnDefs: [
                    {
                        ...
                        render: function(e, a, t, n) {
                            if(viewPermission == 1 && editPermission == 1 && !t.hasContestAuthor){
                ...
                columns: [
                    ...
                    { data: "contest_title", name: "contest_title", sortable: true },
                    { data: "user_contest_title", name: "user_contest_title", sortable: true },
                    { data: "contest_date", name: "contest_date", sortable: true },
                    { data: "author_name", name: "author_name", sortable: true },
                    { data: "rank", name: "rank", sortable: true },
            ...
            $dataTable
                ...
                .on("click", 'input[type="checkbox"]', function(e) {
                    ...
                    ContestAuthors.updateDataTableSelectAllCtrl(table);
