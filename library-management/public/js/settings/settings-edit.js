var Settings = (function() {
    return {
        ...
        init: function() {
            ...
            Settings.initializeComponents();
            Settings.customValidationMethods();
        },
        ...
        enableDisableField: function(clickedLockElement, elementId){
            var clickedLockElementId = $(clickedLockElement).attr('id');
            var isEnabled = $(clickedLockElement).data('enabled');

            if(isEnabled){
                $("#"+clickedLockElementId).find('i').addClass('fa-lock').removeClass('fa-unlock');
                $("#"+elementId).attr('disabled', 'disabled');
                $(clickedLockElement).data('enabled', false);
            }
            else{
                $("#"+clickedLockElementId).find('i').removeClass('fa-lock').addClass('fa-unlock');
                $("#"+elementId).removeAttr('disabled');
                $(clickedLockElement).data('enabled', true);
            }
        }
    };
})();
