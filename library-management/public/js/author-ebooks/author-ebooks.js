var AuthorEbooks = (function() {
    ...
    return {
         ...
         */
        init: function() {
            AuthorEbooks.getRecords();
            AuthorEbooks.changeStatus();
            AuthorEbooks.destroyRecords();
            AuthorEbooks.deleteRecord();
            AuthorEbooks.dataTableCustomFilter();
            AuthorEbooks.initializeComponents();
        },
        ...
        getRecords: function() {
            ...
            $dataTable
                ...
                .on("click", 'input[type="checkbox"]', function(e) {
                    ...
                    AuthorEbooks.updateDataTableSelectAllCtrl(table);
