...
if(recordsFilterType == 'u'){
    var foundIndex = magazineListCols.findIndex(col => col.data == 'type');

    if (foundIndex !== -1) {
        magazineListCols.splice(foundIndex + 1, 0, { 
            data: "is_selected", 
            name: "is_selected", 
            class: "text-center", 
            sortable: true 
    ...
    magazineListCols.splice(3, 0, { data: "date", name: "date", sortable: true })
}
...
var Magazines = (function() {
    ...
    return {
         ...
         */
        init: function() {
            Magazines.getRecords();
            Magazines.changeStatus();
            Magazines.destroyRecords();
            Magazines.deleteRecord();
            Magazines.dataTableCustomFilter();
        ...
        getRecords: function() {
            ...
            data_table = table = $dataTable.DataTable({
                ...
                ajax: {
                    ...
                    data: function(d) {
                        d.filter_magazine_type = recordsFilterType;
                    }
                },
                // columns: [
                //     {
            ...
            $dataTable
                ...
                .on("click", 'input[type="checkbox"]', function(e) {
                    ...
                    Magazines.updateDataTableSelectAllCtrl(table);
