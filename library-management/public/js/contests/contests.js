var Contests = (function() {
    ...
    return {
        ...
        init: function() {
            Contests.getRecords();
            Contests.changeStatus();
            Contests.destroyRecords();
            Contests.deleteRecord();
            Contests.dataTableCustomFilter();
            Contests.initializeComponents();
        },
        ...
        getRecords: function() {
            ...
            data_table = table = $dataTable.DataTable({
                ...
                columns: [
                    ...
                    { data: "contestAuthorCount", name: "contestAuthorCount", sortable: true },
            ...
            $dataTable
                ...
                .on("click", 'input[type="checkbox"]', function(e) {
                    ...
                    Contests.updateDataTableSelectAllCtrl(table);
