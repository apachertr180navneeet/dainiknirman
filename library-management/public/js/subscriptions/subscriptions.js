var Subscriptions = (function() {
    ...
    return {
         ...
         */
        init: function() {
            Subscriptions.getRecords();
            Subscriptions.changeStatus();
            Subscriptions.destroyRecords();
            Subscriptions.deleteRecord();
            Subscriptions.dataTableCustomFilter();
            Subscriptions.initializeComponents();
        },
        ...
        getRecords: function() {
            ...
            data_table = table = $dataTable.DataTable({
                ...
                columns: [
                    ...
                    { data: "validity", name: "validity", sortable: true },
            ...
            $dataTable
                ...
                .on("click", 'input[type="checkbox"]', function(e) {
                    ...
                    Subscriptions.updateDataTableSelectAllCtrl(table);
