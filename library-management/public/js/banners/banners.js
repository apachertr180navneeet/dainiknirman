var Banners = (function() {
    ...
    return {
        ...
        init: function() {
            Banners.getRecords();
            Banners.changeStatus();
            Banners.destroyRecords();
            Banners.deleteRecord();
            Banners.dataTableCustomFilter();
        ...
        getRecords: function() {
                ...
                headerCallback: function(e, a, t, n, s) {
                    if(viewPermission == 1 && editPermission == 1){
                        e.getElementsByTagName("th")[0].innerHTML =
                            '<label class="new-control new-checkbox checkbox-outline-primary m-auto ckbox">\n<input type="checkbox" name="select_all" class="new-control-input chk-parent select-banners-primary" id="banner-all-info">\n<span class="new-control-indicator"></span><span style="visibility:hidden">c</span>\n</label>';
                    }
                },
                columnDefs: [
                    {
                        ...
                        render: function(e, a, t, n) {
                            if(viewPermission == 1 && editPermission == 1){
                                return '<label class="new-control new-checkbox checkbox-outline-primary  m-auto ckbox">\n<input type="checkbox" class="new-control-input child-chk select-banners-primary" id="banner-all-info">\n<span class="new-control-indicator"></span><span style="visibility:hidden">c</span>\n</label>';
                            }
                            else{
                                return '-';
                            }
            ...
            $dataTable
                ...
                .on("click", 'input[type="checkbox"]', function(e) {
                    ...
                    Banners.updateDataTableSelectAllCtrl(table);
