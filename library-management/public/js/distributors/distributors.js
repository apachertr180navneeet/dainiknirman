var Distributors = (function() {
    ...
    return {
         ...
         */
        init: function() {
            Distributors.getRecords();
            Distributors.changeStatus();
            Distributors.destroyRecords();
            Distributors.deleteRecord();
            Distributors.dataTableCustomFilter();
        ...
        getRecords: function() {
            ...
            $dataTable
                ...
                .on("click", 'input[type="checkbox"]', function(e) {
                    ...
                    Distributors.updateDataTableSelectAllCtrl(table);
