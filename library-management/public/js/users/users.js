        ...
        getRecords: function() {
            ...
            data_table = table = $dataTable.DataTable({
                initComplete: function() {
                    ...
                    data_table.page.len(showItemsPerPage);
                ...
                ajax: {
                    ...
                    data: function(d) {
                        d.filter_author_name = searchAuthorName;
                    }
                },
                columns: [
                    {
                    ...
                    { data: "subscription_start", name: "subscription_start", sortable: true },
                    { data: "subscription_end", name: "subscription_end", sortable: true },
