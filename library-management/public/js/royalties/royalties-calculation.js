        ...
        getRecords: function() {
            ...
            data_table = table = $dataTable.DataTable({
                ...
                columns: [
                    ...
                    { data: "sale_qty", name: "sale_qty", sortable: true },
                    { data: "book_price", name: "book_price", sortable: true },
                    { data: "total_royalty", name: "total_royalty", sortable: true },
                    { data: "author_royalty", name: "author_royalty", sortable: true },
                    { data: "app_royalty", name: "app_royalty", sortable: true },
                    { data: "book_file", name: "book_file", sortable: false, className:"text-center" }
                ],
