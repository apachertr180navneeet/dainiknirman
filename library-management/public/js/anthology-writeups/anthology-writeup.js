var Customers = (function() {
    ...
    return {
         ...
         */
        init: function() {
            Customers.getRecords();
            Customers.dataTableCustomFilter();
            Customers.initializeComponents();
        },
        ...
        getRecords: function() {
            ...
            data_table = table = $dataTable.DataTable({
                ...
                columns: [
                    ...
                    //     sortable: false
                    // },
                    { data: "user_mobile", name: "user_mobile", sortable: true },
                    { data: "book_name", name: "book_name", sortable: true },
                    { data: "book_category", name: "book_category", sortable: true },
                    { data: "book_price", name: "book_price", sortable: true },
                    { data: "launch_date", name: "launch_date", sortable: true },
                    { data: "author_amount", name: "author_amount", sortable: true },
                    { data: "admin_amount", name: "admin_amount", sortable: true },
                ],
            ...
            $dataTable
                ...
                .on("click", 'input[type="checkbox"]', function(e) {
                    ...
                    Customers.updateDataTableSelectAllCtrl(table);
