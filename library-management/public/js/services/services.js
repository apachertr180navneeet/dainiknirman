var Services = (function() {
    ...
    return {
        ...
        init: function() {
            ...
            Services.destroyRecords();
            Services.deleteRecord();
            Services.dataTableCustomFilter();
        ...
        getRecords: function() {
            ...
            data_table = table = $dataTable.DataTable({
                ...
                columns: [
                    ...
                    { data: "working_days", name: "working_days", sortable: true },
                    { data: "service_order", name: "service_order", sortable: true },
            ...
            $dataTable
                ...
                .on("click", 'input[type="checkbox"]', function(e) {
                    ...
                    Services.updateDataTableSelectAllCtrl(table);
