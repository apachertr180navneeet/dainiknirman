            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body" style="overflow: auto;">
                        <table id="dataTable" class="table table-bordered table-hover" data-url="{{route('admin.paymentManagement.getPayments')}}">
                            <thead>
                                <tr>
                                    <th>Order No.</th>
...
<!-- /.content -->
@php
$viewPermission = auth()->user()->hasPermissionTo('View Payment Management');
$editPermission = auth()->user()->hasPermissionTo('Edit Payment Management');
$deletePermission = auth()->user()->hasPermissionTo('Delete Payment Management');
@endphp
...
<script src="{{ asset('public/js/payments/payments.js') }}"></script>
@endpush
