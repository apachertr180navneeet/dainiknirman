        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <h3 class="card-title">Anthology Writeups</h3>
                        </div>
                        <div class="col-md-5">
                        </div>
                        <div class="col-md-1">
                    ...
                    <div class="card-body" style="overflow: auto;">
                        <table id="dataTable" class="table table-bordered table-hover" data-url="{{route('admin.anthologyWriteup.getAnthologyWriteups')}}">
                            <thead>
                                <tr>
                                    <!-- <th>S.no.</th> -->
...
<!-- /.content -->
@php
$viewPermission = auth()->user()->hasPermissionTo('View Anthology Writeup');
$editPermission = auth()->user()->hasPermissionTo('Edit Anthology Writeup');
$deletePermission = auth()->user()->hasPermissionTo('Delete Anthology Writeup');
@endphp
...
<script src="{{ asset('public/js/anthology-writeups/anthology-writeup.js') }}"></script>
@endpush
