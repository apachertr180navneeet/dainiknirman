            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{ route('admin.cms.store') }}" method="post" id="add-magazine-form" enctype="multipart/form-data">
                            @csrf
                            <!-- Card body -->
                            <div class="card-body">
                                <div class="row row-sm">
                                    <div class="col-md-6 col-lg-6 col-xl-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="title" name="title" value="{{ old('title') }}" placeholder="Enter Title" data-check-url="{{route('admin.cms.checkMagazineName')}}"/>
                                        </div>
                                    </div>
                                    <div class="col-md-6 col-lg-6 col-xl-6">
                                        <div class="form-group">
