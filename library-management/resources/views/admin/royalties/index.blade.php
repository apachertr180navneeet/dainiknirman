                ...
                <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 text-right">
                            <!-- Add Button -->
                            <a href="{{route('admin.royalties.calculation')}}" class="btn btn-primary"><i class="fas fa-calculator"></i> Calculations</a>
                        </div>
                    </div>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body" style="overflow: auto;">
                        <table id="dataTable" class="table table-bordered table-hover" data-url="{{route('admin.royalties.getRoyalties')}}" data-payment-status-url="{{route('admin.royalties.changePaymentStatus')}}">
                            <thead>
                                <tr>
                                    <th>S.no.</th>
                                    <th>Order No.</th>
...
<!-- /.content -->
@php
$viewPermission = auth()->user()->hasPermissionTo('View Royalty');
$editPermission = auth()->user()->hasPermissionTo('Edit Royalty');
$deletePermission = auth()->user()->hasPermissionTo('Delete Royalty');
@endphp
...
<script>
    ...
    var searchBook = '{{request()->get("book") && !empty(request()->get("book")) ? request()->get("book") : ""}}';
</script>
...
<script src="{{ asset('public/js/royalties/royalties.js') }}"></script>
@endpush
