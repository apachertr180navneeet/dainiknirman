...
@section('title', 'Royalties Calculation')
        ...
        <div class="row">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <h3 class="card-title">Royalties Calculation</h3>
                        </div>
                        <div class="col-md-5">
                        </div>
                        <div class="col-md-1">
                    ...
                    <div class="card-body" style="overflow: auto;">
                        <table id="dataTable" class="table table-bordered table-hover" data-url="{{route('admin.royalties.getRoyaltyCalculation')}}">
                            <thead>
                                <tr>
                                    <!-- <th>S.no.</th> -->
                                    <th>Book</th>
...
<script src="{{ asset('public/js/royalties/royalties-calculation.js') }}"></script>
@endpush
