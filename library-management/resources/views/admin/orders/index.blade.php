            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body" style="overflow: auto;">
                        <table id="dataTable" class="table table-bordered table-hover" data-url="{{route('admin.orders.getOrders')}}">
                            <thead>
                                <tr>
                                    <th>Order No.</th>
                                    <th>Book Name</th>
...
<!-- /.content -->
@php
$viewPermission = auth()->user()->hasPermissionTo('View Orders');
$editPermission = auth()->user()->hasPermissionTo('Edit Orders');
$deletePermission = auth()->user()->hasPermissionTo('Delete Orders');
@endphp
...
<script src="{{ asset('public/js/orders/orders.js') }}"></script>
@endpush
