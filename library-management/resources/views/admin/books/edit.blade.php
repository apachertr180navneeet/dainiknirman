                    ...
                    <form role="form" action="{{ route('admin.books.update', ['id' => $book->id]) }}" method="post" id="edit-book-form" enctype="multipart/form-data">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row row-sm">
                                <div class="col-md-6 col-lg-6 col-xl-6">
                                    <div class="form-group">
                                        <label class="">Book Category</label>
                                        <select class="form-control select-picker" id="category_type" name="category_type" data-get-authors="{{route('admin.books.getAuthors')}}" disabled>
                                            <!-- <option value="">Select</option> -->
                                            @if(!empty($bookCategories))
                                                @foreach($bookCategories as $key => $value)
                                                    <option value="{{$value['value']}}" {{$book->book_category == $value['value'] ? 'selected' : ''}}>{{$value['caption']}}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                    </div>
                                ...
                                <div class="col-md-6 col-lg-6 col-xl-6">
                                    @php
                                    $bookAuthors = $book->bookCategoryAuthor->pluck('author_id');
                                    @endphp
                                    <div class="form-group">
                                        <label class="">Select Author</label>
                                        <select class="form-control select-picker" id="author_id" name="author_id[]", multiple>
                                            <option value="">Select</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="row row-sm">
                                <div class="col-md-6 col-lg-6 col-xl-6">
                                    ...
                                    if(isset($book->cover_picture) && !empty($book->cover_picture))
                                    {
                                        ...
                                        $coverPictureImage = \Storage::disk("local")->url("book/cover/".$coverPictureImage);
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 col-lg-12 col-xl-12">
                                            ...
                                            if(isset($book->book_pdf) && !empty($book->book_pdf))
                                            {
                                                ...
                                                $bookPdf = \Storage::disk("local")->url("book/pdf/".$bookPdf);
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file" class="form-control" id="book_pdf" name="book_pdf" data-pdf="{{$book->book_pdf}}"/>
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-lg-12 col-xl-12">
                                            <div class="form-group">
                                                <label class="">Original Price</label>
                                                <input type="text" class="form-control" id="original_price" name="original_price" value="{{ $book->original_price }}" placeholder="Enter Original Price" />
                                            </div>
                                        </div>
                                        <div class="col-md-12 col-lg-12 col-xl-12">
                                            <div class="form-group">
...
@push('scripts')
<script>
    var bookAuthors = "{{$bookAuthors->toJson()}}";
