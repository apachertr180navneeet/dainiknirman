            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form role="form" action="{{ route('admin.subscriptions.store') }}" method="post" id="add-subscription-form" enctype="multipart/form-data">
                            @csrf
                            <!-- Card body -->
                            <div class="card-body">
                                <div class="row row-sm">
                                    <div class="col-md-4 col-lg-4 col-xl-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="name" name="name" value="{{ old('name') }}" placeholder="Enter Subscription Name" data-check-url="{{route('admin.subscriptions.checkSubscriptionName')}}"/>
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-lg-4 col-xl-4">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-4 col-lg-4 col-xl-4">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" id="validity" name="validity" value="{{ old('validity') }}" placeholder="Enter Validity"/>
                                        </div>
                                    </div>
                                </div>
...
<script src="{{ asset('public/js/subscriptions/subscriptions-create.js') }}"></script>
@endpush