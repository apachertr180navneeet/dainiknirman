            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            @if(auth()->user()->hasPermissionTo('Add Ebook Upload Author'))
                                {{-- <a href="{{ route('admin.author-ebooks.create') }}" class="btn btn-block btn-primary"><i class="fas fa-plus"></i> Add</a> --}}
                            @endif
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="card-body" style="overflow: auto;">
                        <table id="dataTable" class="table table-bordered table-hover" data-url="{{route('admin.author-ebooks.getAuthorEbooks')}}" data-destroy-url="{{route('admin.author-ebooks.destroy')}}" data-change-status-url="{{route('admin.author-ebooks.changeStatus')}}" data-export-csv-url="{{route('admin.author-ebooks.export', ['type' => 'excel'])}}">
                            <thead>
                                <tr>
                                    <th>S.no.</th>
                                    <th>Title</th>
...
<!-- /.content -->
@php
$viewPermission = auth()->user()->hasPermissionTo('View Ebook Upload Author');
$editPermission = auth()->user()->hasPermissionTo('Edit Ebook Upload Author');
$deletePermission = auth()->user()->hasPermissionTo('Delete Ebook Upload Author');
@endphp
...
<script src="{{ asset('public/js/author-ebooks/author-ebooks.js') }}"></script>
@endpush
