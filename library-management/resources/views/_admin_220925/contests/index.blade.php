            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1">
                            @if(auth()->user()->hasPermissionTo('Add Contest'))
                                <a href="{{ route('admin.contests.create') }}" class="btn btn-block btn-primary"><i class="fas fa-plus"></i> Add</a>
                            @endif
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="card-body" style="overflow: auto;">
                        <table id="dataTable" class="table table-bordered table-hover" data-url="{{route('admin.contests.getContests')}}" data-destroy-url="{{route('admin.contests.destroy')}}" data-change-status-url="{{route('admin.contests.changeStatus')}}" data-export-csv-url="{{route('admin.contests.export', ['type' => 'excel'])}}">
                            <thead>
                                <tr>
                                    <th>S.no.</th>
                                    <th>Title</th>
...
<!-- /.content -->
@php
$viewPermission = auth()->user()->hasPermissionTo('View Contest');
$editPermission = auth()->user()->hasPermissionTo('Edit Contest');
$deletePermission = auth()->user()->hasPermissionTo('Delete Contest');
@endphp
...
<script src="{{ asset('public/js/contests/contests.js') }}"></script>
@endpush
